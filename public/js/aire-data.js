...
const AireData = (() => {
  ...
  const STAGES = {
    egg:         { label: "Egg",         img: "/images/egg.png"},
    pupa:        { label: "Pupa",        img: "/images/pupa.png"},
    caterpillar: { label: "Caterpillar", img: "/images/caterpillar.png"},
    butterfly:   { label: "Butterfly",   img: "/images/daisybutterfly.png"},
    surviving:   { label: "Surviving",   img: "/images/surviving.jpeg" },
    struggling:  { label: "Struggling",  img: "/images/struggling.jpeg" },
  };
